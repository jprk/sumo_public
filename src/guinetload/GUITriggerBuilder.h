...
protected:
    ...
    * @param[in] sectionID The id of the overhead wire section this segment belongs to (informative, may be empty)
    ...
    */
    MSOverheadWire* buildOverheadWireSegment(MSNet& net, const std::string& id, const std::string& sectionID, const MSLane* lane,
